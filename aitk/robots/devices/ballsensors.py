        ...
        if self.width != 0:
            for incr in arange(-self.width / 2, self.width / 2, self.width / 2):
                ...
                if hits:
                    ...
                    # Closest hit:
                    """
                    TODO: Modify this to find the ball
                    ...
                    for hit in hits:
                        if hit.ball == None:
                            continue
                        position = hit.ball.get_position()
                        self.ball_distance = hit.distance
                        self.ball_angle = -self.robot.a - self.a
